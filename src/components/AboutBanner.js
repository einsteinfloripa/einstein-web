                  ...
                  <div className="relative px-4 py-6 sm:px-6 sm:py-24 lg:py-8 lg:px-8">
                    <div className="flex align-middle" >
                        ...
                        <div className="w-4/6 h-full pl-2 self-center py-3 bg-transparent rounded-xl">
                            <h1 className="text-center font-semibold tracking-tight sm:text-5xl lg:text-3xl">
                                <span className="block text-white lg:text-3xl sm:text-2xl">Nas universides de maior perfomance do país, 70% dos universitários vieram de escolas particulares</span>
                            </h1>
                        </div>
                    </div>
                    <img
