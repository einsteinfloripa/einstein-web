    ...
    <>
            ...
            <div className='absolute inset-x-0 bottom-0'>
              <div className='flex justify-center lg:w-full'>
                {/*<img
                                    ...
                                    src="/images/educacao-a-arma-mais-poderosa.png"
                                    alt="docente e aluno"
                                />*/}
              </div>
            </div>
      ...
      {/*<div className="relative">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="relative px-4 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8">
                    <img
                        className="lg:w-auto w-3/8 pt-30"
        ...
        <div className='max-w-7xl mx-auto sm:px-6 lg:px-8'>
          ...
          <div className='relative px-4 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8'>
            <h2 className='font-semibold tracking-tight'>
              ...
              <span className='block text-white lg:text-2xl text-2xl py-4'>
                Se tornando um Amigo do Einstein você estará investindo na
                educação de Santa Catarina. Assim, você nos ajuda a fornecer
                melhores condições para os nossos alunos e professores.
              </span>
            </h2>
          </div>
        </div>
          ...
          <div className='relative px-4 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8'>
            <h2 className='font-semibold tracking-tight'>
              ...
              <span className='block text-blue-900 lg:text-2xl text-2xl py-4'>
                O Einstein Floripa já impactou mais de 600 vidas! Aqui, além de
                impactar a vida dos nossos alunos, procuramos fazer o mesmo com
                a vida dos organizadores e docentes, oferecendo capacitação e
                desenvolvimento para estes universitários. É um aprendizado de
                aluno para aluno!
              </span>
            </h2>
          </div>
        ...
        <div className='max-w-7xl mx-auto sm:px-6 lg:px-8'>
          ...
          <div className='relative px-4 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8'>
            <h2 className='font-semibold tracking-tight'>
              ...
              <span className='block text-white lg:text-2xl text-2xl py-4'>
                Se tornando um Amigo do Einstein você ajudará a melhorar a vida
                de jovens em situação de vulnerabilidade econômica, ajudando-os
                a ingressar em uma universidade de qualidade.
              </span>
            </h2>
          </div>
        </div>
        ...
        <div className='max-w-7xl mx-auto sm:px-6 lg:px-8'>
          ...
          <div className='relative px-4 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8'>
            <h2 className='font-semibold tracking-tight'>
              ...
              <span className='block text-blue-900 lg:text-2xl text-2xl py-4'>
                Cada um de nossos alunos sonha em se graduar na especialidade
                favorita e se tornar um profissional de destaque. Nós abraçamos
                esses sonhos e ajudamos a realizá-los!
              </span>
            </h2>
          </div>
        </div>
        ...
        <div className='max-w-7xl mx-auto sm:px-6 lg:px-8'>
          ...
          <div className='relative px-4 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8'>
            <h2 className='font-semibold tracking-tight'>
              ...
              <span className='block text-white lg:text-2xl text-2xl py-4'>
                Além de todo o impacto positivo, nossos Amigos do Einstein ainda
                têm acesso a benefícios exclusivos, como a newsletter mensal da
                instituição, para ficar por dentro de tudo que acontece no
                Einstein e também benefícios oferecidos pelos nossos parceiros.
              </span>
            </h2>
          </div>
        </div>
        ...
        <div className='max-w-7xl mx-auto sm:px-6 lg:px-8'>
          ...
          <div className='relative px-4 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8'>
            <h2 className='font-semibold tracking-tight text-center'>
              ...
              <span className='block lg:text-2xl text-2xl text-blue-900 mt-2'>
                CLIQUE ABAIXO NO PLANO QUE MAIS SE ENCAIXA COM VOCÊ!
              </span>
            </h2>
          </div>
        </div>
      ...
      <div className='relative'>
        <div className='grid 2xl:grid-cols-5 lg:grid-cols-3'>
          <div className='bg-blue-900 group'>
            <Link href={`/jogo?id=${handleDonationForm(5, 'value').id}`}>
              <div className='relative px-4 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8 text-center space-y-6'>
                <h2 className='font-semibold tracking-tight'>
                  ...
                  <span className='block text-white text-1xl md:text-3xl lg:text-4xl xl:text-5xl group-hover:text-blue-50'>
                    Mensais
                  </span>
                </h2>
                <h3 className='font-semibold tracking-tight'>
                  <span className='text-base text-white group-hover:text-blue-50'>
                    Você proporciona material didático para dois estudantes por
                    um mês
                  </span>
                </h3>
              </div>
          ...
          <div
            style={{ backgroundColor: "#2F6BA8" }}
            className='bg-blue-800 group'
          >
            <Link href={`/jogo?id=${handleDonationForm(15, 'value').id}`}>
              <div className='relative px-4 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8 text-center	space-y-6'>
                <h2 className='font-semibold tracking-tight'>
                  ...
                  <span className='block text-white text-1xl md:text-3xl lg:text-4xl xl:text-5xl'>
                    Mensais
                  </span>
                </h2>
                <h3 className='font-semibold tracking-tight'>
          ...
          <div style={{ backgroundColor: "#0185C3" }} className='bg-blue-700'>
            <Link href={`/jogo?id=${handleDonationForm(25, 'value').id}`}>
              <div className='relative px-4 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8 text-center	space-y-6'>
                <h2 className='font-semibold tracking-tight'>
                  <span className='block text-white text-1xl md:text-2xl lg:text-3xl xl:text-4xl'>
                    R$
          ...
          <div style={{ backgroundColor: "#47B2DF" }} className='bg-blue-600'>
            <Link href={`/jogo?id=${handleDonationForm(60, 'value').id}`}>
              <div className='relative px-4 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8 text-center	space-y-6'>
                <h2 className='font-semibold tracking-tight'>
                  <span className='block text-white text-1xl md:text-2xl lg:text-3xl xl:text-4xl'>
                    R$
          ...
          <div style={{ backgroundColor: "#6DD2E0" }} className='bg-blue-500'>
            <Link href={`/jogo?id=${handleDonationForm(100, 'value').id}`}>
              <div className='relative px-4 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8 text-center	space-y-6'>
                <h2 className='font-semibold tracking-tight'>
                  <span className='block text-white text-1xl md:text-2xl lg:text-3xl xl:text-4xl'>
                    R$
                ...
                <h3 className='font-semibold tracking-tight'>
                  <span className='text-base text-white'>
                    Você proporciona meio ano letivo de estudo para um aluno com
                    todas as despesas do projeto incluídas
                  </span>
                </h3>
              </div>
            </Link>
            ...
            <div className='relative'>
              <div className='grid md:grid-cols-2'>
                <div className='relative'>
                  <div className='grid grid-cols-2 space-x-4'>
                    ...
                    <div className='text-blue-900'>
                      ...
                      <br />
                      <strong>CNPJ:</strong> 23.637.930/0001-56
                ...
                <div>
                  ...
                  >
                    <img
                      className='w-60 m-auto pt-8 md:pt-0'
