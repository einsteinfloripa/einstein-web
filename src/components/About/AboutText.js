function AboutText() {
  return (
    <main>
          ...
          <div aria-hidden="true" className="absolute inset-x-0 top-0 h-full bg-blue-50" />
              ...
              <div className="mt-12 sm:mt-16 lg:mt-0">
                <div className="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:py-16 lg:relative lg:h-full">
                  <div className="md:flex md:flex-col">
                    <div className="self-center bg-blue-800 rounded-xl lg:h-full lg:w-full w-4/6 flex justify-center">
