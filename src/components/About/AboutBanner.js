                    ...
                    <div className="flex mt-10 align-middle" >
                        <div className="w-4/6 h-full self-center bg-transparent rounded-xl py-8">
                            <h1 className="text-center font-semibold tracking-tight sm:text-5xl lg:text-3xl">
                                <span className="text-blue-900 lg:text-3xl sm:text-2xl">Cerca de </span>
                                <span className="text-blue lg:text-3xl sm:text-2xl">85% </span>
                                <span className="text-blue-900 lg:text-3xl sm:text-2xl">dos estudantes brasileiros estão em escolas públicas</span>
                            </h1>
                        </div>
                        ...
                        <div className="w-4/6 h-full pl-2 self-center py-3 bg-transparent rounded-xl">
                            <h1 className="text-center font-semibold tracking-tight sm:text-5xl lg:text-3xl">
                                <span className="text-blue-900 lg:text-3xl sm:text-2xl">Nas universides de maior perfomance do país,</span>
                                <span className="text-blue lg:text-3xl sm:text-2xl"> 70% </span>
                                <span className="text-blue-900 lg:text-3xl sm:text-2xl">universitários vieram de escolas particulares</span>
                            </h1>
                        </div>
                    </div>
                  </div>
