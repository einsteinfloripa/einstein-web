        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:pt-32 lg:pb-24 lg:px-8">
                ...
                <div className="mt-6 self-center flex justify-center">
                  <a
                    href="https://app.pipefy.com/public/form/SnZzVUr0" target="Starfall"
            ...
            <div className="relative px-10 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8">
                <h2 className="text-justify font-extrabold tracking-tight">
                    <span className="block text-white lg:text-4xl text-2xl">
                      Conquiste com o Einstein Floripa!
                    </span>
                    <span className="block text-white lg:text-4xl text-2xl mt-10">
                      Nossas pré-inscrições estão abertas!! 
                    </span>  
                    <span className="block text-white lg:text-4xl text-2xl mt-10">
                    ...
                    <span className="block text-white lg:text-4xl text-2xl mt-10">
                      O caminho para ser Einsteiniano: 
                      Todo o  Processo Seletivo será realizado de maneira online, em função das medidas de prevenção à Covid-19.
                    </span>
                    <span className="block text-white lg:text-4xl text-2xl mt-10">  
