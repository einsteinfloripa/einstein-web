            ...
            <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:pt-32 lg:pb-24 lg:px-8">
                <h1 className="text-center font-extrabold tracking-tight">
                    <span className="block text-blue-900 lg:text-5xl text-2xl">
                        Bem-vindo(a) à página de Processo Seletivo de Docentes!
                    </span>
                </h1>
            ...
            <div className="relative px-10 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8">
                <h2 className="text-justify font-semibold tracking-tight">
                    <span className="block text-blue lg:text-4xl text-2xl">
                      O Einstein Floripa está com vagas abertas para professores e monitores!
                    </span>
                    ...
                    <span className="block text-white lg:text-4xl text-2xl my-10 font-medium">
                      O processo seletivo de docentes é composto por três etapas, que serão realizadas de maneira online:
                    </span>
                </h2>
                <div className="mb-10">
                  <h2 className="text-justify font-semibold tracking-tight bg-white p-5 rounded-lg">
                      <span className="block text-blue-900 lg:text-4xl text-2xl">  
                        <span className="text-blue">1. Inscrições - </span> os candidatos devem ler o edital na íntegra e preencher o formulário com as informações solicitadas. 
                      </span> 
                  </h2>
                </div>
                <div className="mb-10">
                  <h2 className="text-justify font-semibold tracking-tight bg-white p-5 rounded-lg">
                      <span className="block text-blue-900 lg:text-4xl text-2xl">  
                        <span className="text-blue">2. Aula teste - </span> após a aprovação na primeira etapa, baseada no cumprimento dos pré-requisitos para a atuação no projeto, os candidatos devem elaborar uma aula-teste com temas previamente delimitados e entregar o material a ser utilizado com antecedência.
                      </span> 
                  </h2>
                </div>
                <div className="mb-10">
                  <h2 className="text-justify font-semibold tracking-tight bg-white p-5 rounded-lg">
                      <span className="block text-blue-900 lg:text-4xl text-2xl">   
                        <span className="text-blue">3. Entrevistas - </span> ocorre logo após a aula-teste, e é um momento para conhecermos melhor nossos futuros docentes! Serão avaliados o alinhamento com a missão do projeto e o comprometimento com a atuação dentro do cursinho. 
                      </span> 
                  </h2>
                </div>
                <h2 className="text-justify font-medium tracking-tight">
                    <span className="block text-white lg:text-4xl text-2xl mt-10"> 
                      Com a aprovação em todas as etapas, seja bem vindo(a) à sua jornada no Einstein Floripa! Aos poucos serão passadas mais informações para que você comece a transformar a educação conosco!
                    </span> 
                    <span className="block text-white lg:text-4xl text-2xl mt-10"> 
                ...
                <div className="relative px-4  sm:px-6 lg:px-8 pb-10">
                  ...
                  <div className="mt-6 flex justify-start flex-col">
                    <div className="mt-8">
                      ...
                      >
                        Edital do processo  de docentes de 2022 (Atual)
                      </a>
                    </div> 
                    <div className="mt-8">
                      <a
                        ...
                        className="text-center text-2xl font-semibold inline-flex bg-blue-50 bg-origin-border px-4 py-2 border border-transparent rounded-md shadow-sm text-blue-900 hover:bg-blue hover:text-white"
                      >
                        Edital do processo  de docentes de 2022 (Fora de uso)
                      </a>
                    </div>
                  </div>
                </div>
