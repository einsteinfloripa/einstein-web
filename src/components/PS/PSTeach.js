...
function PSTeach() {
  ...
  const linkEditalPS =
    "https://drive.google.com/file/d/1G8GiO8iTBgquUm09dDVXvmR6XhCRqaY_/view";
          ...
          <div className='relative px-10 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8'>
            <h2 className='text-justify font-semibold tracking-tight'>
              <span className='block text-blue lg:text-4xl text-2xl'>
                O Einstein Floripa está com vagas abertas para professores e
                monitores!
              </span>
              ...
              <span className='block text-white lg:text-4xl text-2xl my-10 font-medium'>
                O processo seletivo de docentes é composto por três etapas, que
                serão realizadas de maneira online:
              </span>
            </h2>
            <div className='mb-10'>
            ...
            <div className='mb-10'>
              <h2 className='text-justify font-semibold tracking-tight bg-white p-5 rounded-lg'>
                <span className='block text-blue-900 lg:text-4xl text-2xl'>
                  <span className='text-blue'>2. Aula teste - </span> após a
                  aprovação na primeira etapa, baseada no cumprimento dos
                  pré-requisitos para a atuação no projeto, os candidatos devem
                  elaborar uma aula-teste com temas previamente delimitados e
                  entregar o material a ser utilizado com antecedência.
                </span>
              </h2>
            </div>
            <div className='mb-10'>
              <h2 className='text-justify font-semibold tracking-tight bg-white p-5 rounded-lg'>
                <span className='block text-blue-900 lg:text-4xl text-2xl'>
                  ...
                  logo após a aula-teste, e é um momento para conhecermos melhor
                  nossos futuros docentes! Serão avaliados o alinhamento com a
                  missão do projeto e o comprometimento com a atuação dentro do
                  cursinho.
                </span>
              </h2>
            </div>
            ...
            <div className='relative px-4  sm:px-6 lg:px-8 pb-10'>
              ...
              <div className='mt-6 flex justify-start flex-col'>
                <div>
                  ...
                  >
                    Edital do processo seletivo de docentes 2024.2
                  </a>
                </div>
              </div>
            </div>
