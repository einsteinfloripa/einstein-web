...
function PSTeach() {
  ...
  const linkEditalPS =
    "https://drive.google.com/file/d/16TPOH9V-GSCo--rU5YEH2OH9NdHvi6UO/view";
          ...
          <div className='relative px-4 py-16 sm:px-6 sm:py-24 lg:pt-32 lg:pb-24 lg:px-8'>
            <h1 className='font-extrabold tracking-tight text-center'>
              <span className='block text-2xl text-blue-900 lg:text-4xl'>
                Bem-vindo(a) à página de Processo Seletivo de Docente!
              </span>
            </h1>
            ...
            <div className='mt-16'>
              ...
              <div className='flex flex-col justify-start mt-6'>
                <div>
                  ...
                  >
                    Edital do processo seletivo de docentes 2025.1  
                  </a>
                </div>
              </div>
            </div>
