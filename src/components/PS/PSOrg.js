          ...
          <div className="relative px-10 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8">
            <h2 className="text-justify font-semibold tracking-tight">
              ...
              <span className="block text-white lg:text-4xl text-2xl my-10 font-medium">
                O processo seletivo de organizadores é composto por três etapas, que serão realizadas de maneira online:
                    </span>
            </h2>
            <div className="mb-10">
            ...
            <div className="mb-10">
              <h2 className="text-justify font-semibold tracking-tight bg-white p-5 rounded-lg">
                <span className="block text-blue-900 lg:text-4xl text-2xl">
                  <span className="text-blue">2. Case e Teste de raciocínio - </span> após a aprovação na primeira etapa, baseada no cumprimento dos pré-requisitos para a atuação no projeto, os candidatos devem elaborar um case com temas previamente delimitados e realizar um teste de raciocínio no Mindsight.
                      </span>
              </h2>
            </div>
            <div className="mb-10">
              <h2 className="text-justify font-semibold tracking-tight bg-white p-5 rounded-lg">
                <span className="block text-blue-900 lg:text-4xl text-2xl">
                  <span className="text-blue">3. Entrevistas - </span> ocorre logo após a etapa 2, e é um momento para conhecermos melhor nossos futuros organizadores! Serão avaliados o alinhamento com a missão do projeto e o comprometimento com a atuação dentro do cursinho.
                      </span>
              </h2>
            </div>
