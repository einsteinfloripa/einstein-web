            ...
            <div className="relative px-4 py-16 sm:px-6 sm:py-16 lg:py-20 lg:px-8">
                <h2 className="text-justify font-extrabold tracking-tight">
                    ...
                    <span className="block text-white lg:text-4xl text-2xl mt-10">
                      Além disso, este ano estamos disponibilizando o Manual do Candidato, um documento no qual explicamos o Processo Seletivo com uma linguagem descontraída e tiramos as principais dúvidas que podem surgir.Boa sorte!
                    </span>
                    <span className="block text-white lg:text-4xl text-2xl mt-10">
                      Boa sorte!
                    </span>
